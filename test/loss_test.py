...
from utils import translate_inputs
...
def loss_test():
    ...
    trainer_ref = build_ref_trainer(4, batch_size=8, train_dataset=['LiteData'])
...
#
 ...
 #   model_pad.eval()
    ...
    #reprod_log_ref.add("image", output_ref.cpu().detach().numpy())
    ...
    #reprod_log_pad.add("image", outputs_pad.cpu().detach().numpy()) 
