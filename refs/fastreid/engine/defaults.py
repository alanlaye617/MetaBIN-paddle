...
class DefaultTrainer(SimpleTrainer):
    ...
    def domain_distance(cls, cfg, model):
        ...
        with torch.no_grad():
            ...
            #
            #         if not only_all:
            #             plot_hist(pos_dist, neg_dist, width_gap, pos_color, neg_color, metric, dpi, fig_size1, fig_size2)
            #
            #
            # save_path = os.path.join(cfg.OUTPUT_DIR, 'hist_test', 'all_cos_{}.png'.format(str(test_set)))
            # plot_hist(pos_dist_all_cos, neg_dist_all_cos, width_gap, pos_color, neg_color, 'cos', dpi, fig_size1, fig_size2)
            # save_path = os.path.join(cfg.OUTPUT_DIR, 'hist_test', 'all_cos_h20_{}.png'.format(str(test_set)))
            # plot_hist(pos_dist_all_cos, neg_dist_all_cos, width_gap, pos_color, neg_color, 'cos', dpi, fig_size1, fig_size2, kde=False, bin = 20)
            # save_path = os.path.join(cfg.OUTPUT_DIR, 'hist_test', 'all_cos_h30_{}.png'.format(str(test_set)))
            # plot_hist(pos_dist_all_cos, neg_dist_all_cos, width_gap, pos_color, neg_color, 'cos', dpi, fig_size1, fig_size2, kde=False, bin = 30)
            # save_path = os.path.join(cfg.OUTPUT_DIR, 'hist_test', 'all_cos_h40_{}.png'.format(str(test_set)))
            # plot_hist(pos_dist_all_cos, neg_dist_all_cos, width_gap, pos_color, neg_color, 'cos', dpi, fig_size1, fig_size2, kde=False, bin = 40)
            # save_path = os.path.join(cfg.OUTPUT_DIR, 'hist_test', 'all_cos_both_h20_{}.png'.format(str(test_set)))
            # plot_hist(pos_dist_all_cos, neg_dist_all_cos, width_gap, pos_color, neg_color, 'cos', dpi, fig_size1, fig_size2, kde=False, bin = 20, both = True)
            # save_path = os.path.join(cfg.OUTPUT_DIR, 'hist_test', 'all_cos_both_h30_{}.png'.format(str(test_set)))
            # plot_hist(pos_dist_all_cos, neg_dist_all_cos, width_gap, pos_color, neg_color, 'cos', dpi, fig_size1, fig_size2, kde=False, bin = 30, both = True)
            # save_path = os.path.join(cfg.OUTPUT_DIR, 'hist_test', 'all_cos_both_h40_{}.png'.format(str(test_set)))
            # plot_hist(pos_dist_all_cos, neg_dist_all_cos, width_gap, pos_color, neg_color, 'cos', dpi, fig_size1, fig_size2, kde=False, bin = 40, both = True)
            #
            # save_path = os.path.join(cfg.OUTPUT_DIR, 'hist_test', 'all_euc_{}.png'.format(str(test_set)))
            # plot_hist(pos_dist_all_euc, neg_dist_all_euc, width_gap, pos_color, neg_color, 'euc', dpi, fig_size1, fig_size2)
            # save_path = os.path.join(cfg.OUTPUT_DIR, 'hist_test', 'all_euc_h20_{}.png'.format(str(test_set)))
            # plot_hist(pos_dist_all_euc, neg_dist_all_euc, width_gap, pos_color, neg_color, 'euc', dpi, fig_size1, fig_size2, kde=False, bin = 20)
            # save_path = os.path.join(cfg.OUTPUT_DIR, 'hist_test', 'all_euc_h30_{}.png'.format(str(test_set)))
            # plot_hist(pos_dist_all_euc, neg_dist_all_euc, width_gap, pos_color, neg_color, 'euc', dpi, fig_size1, fig_size2, kde=False, bin = 30)
            # save_path = os.path.join(cfg.OUTPUT_DIR, 'hist_test', 'all_euc_h40_{}.png'.format(str(test_set)))
            # plot_hist(pos_dist_all_euc, neg_dist_all_euc, width_gap, pos_color, neg_color, 'euc', dpi, fig_size1, fig_size2, kde=False, bin = 40)
            # save_path = os.path.join(cfg.OUTPUT_DIR, 'hist_test', 'all_euc_both_h20_{}.png'.format(str(test_set)))
            # plot_hist(pos_dist_all_euc, neg_dist_all_euc, width_gap, pos_color, neg_color, 'euc', dpi, fig_size1, fig_size2, kde=False, bin = 20, both = True)
            # save_path = os.path.join(cfg.OUTPUT_DIR, 'hist_test', 'all_euc_both_h30_{}.png'.format(str(test_set)))
            # plot_hist(pos_dist_all_euc, neg_dist_all_euc, width_gap, pos_color, neg_color, 'euc', dpi, fig_size1, fig_size2, kde=False, bin = 30, both = True)
            # save_path = os.path.join(cfg.OUTPUT_DIR, 'hist_test', 'all_euc_both_h40_{}.png'.format(str(test_set)))
            # plot_hist(pos_dist_all_euc, neg_dist_all_euc, width_gap, pos_color, neg_color, 'euc', dpi, fig_size1, fig_size2, kde=False, bin = 40, both = True)
    ...
    def visualize(cls, cfg, model):
        ...
        #     train_num_images = 3  # less than
        #     train_skip_epoch = 0
        #     minimum_number_of_images = 3  # more than
        # elif idx_case == 1:
        #     test_num_classes = 40
        #     test_num_images = 2
        #     train_num_classes = 20
        #     train_num_images = 3  # less than
        #     train_skip_epoch = 0
        #     minimum_number_of_images = 3  # more than
        # elif idx_case == 2:
        ...
        all_dataset = ["CUHK02", "CUHK03_detected", "Market1501", "DukeMTMC", "CUHK_SYSU", "GRID", "VIPER", "PRID",
                       "iLIDS"]
